...
public class _200NumberOfIslands {
     ...
     */
    private void markIslandAsVisited(char[][] grid, int row, int col, int rows, int cols) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("=== Test Case 3: Single Cell Cases ===");
        char[][] grid3 = {
                {'1'}
        };
        System.out.println("Input Grid:");
        ...
        System.out.println("=== Test Case 4: No Islands ===");
        char[][] grid4 = {
                {'0', '0', '0'},
                {'0', '0', '0'},
                {'0', '0', '0'}
        ...
        System.out.println("Number of Islands: " + result4);
