...
public class _025ReverseNodesInKGroup {
    ...
    public static void main(String[] args) {
        // Test case 1
        ListNode list1 = buildList(List.of(1, 2, 3, 4, 5));
        int k1 = 2;
        ListNode reversed1 = new _025ReverseNodesInKGroup().reverseKGroup(list1, k1);
        System.out.println("Test 1 Output: " + toList(reversed1)); // [2, 1, 4, 3, 5]

        // Test case 2
        ListNode list2 = buildList(List.of(1, 2, 3, 4, 5));
        int k2 = 3;
        ListNode reversed2 = new _025ReverseNodesInKGroup().reverseKGroup(list2, k2);
        System.out.println("Test 2 Output: " + toList(reversed2)); // [3, 2, 1, 4, 5]

        // Test case 3: Less than k nodes
        ListNode list3 = buildList(List.of(1, 2));
        int k3 = 3;
        ListNode reversed3 = new _025ReverseNodesInKGroup().reverseKGroup(list3, k3);
        System.out.println("Test 3 Output: " + toList(reversed3)); // [1, 2]
    }
}
