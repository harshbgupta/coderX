...
fun main(args: Array<String>) {
    ...
    println("Input: '$string1', Output: ${lengthOfLongestSubstringOptimized(string1)}") // Expected: 3 ("wke")
    println("Input: '$string2', Output: ${lengthOfLongestSubstringOptimized(string2)}") // Expected: 3 ("abc")
    println("Input: '$string3', Output: ${lengthOfLongestSubstringOptimized(string3)}") // Expected: 1 ("b")
    println("Input: '$string4', Output: ${lengthOfLongestSubstringOptimized(string4)}") // Expected: 0
    println("Input: '$string5', Output: ${lengthOfLongestSubstringOptimized(string5)}") // Expected: 2 ("ab" or "ba")
}
/**
